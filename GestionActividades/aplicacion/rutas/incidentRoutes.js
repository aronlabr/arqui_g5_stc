...
); //Obtener incidente por ID del punto de atención
...
router.get(
  '/date/:creationDate',
  incidentController.getIncidentsByCreationDate,
); //obtener incidente por día de creación
...
router.put(
  '/updatetosolved/:incidentId',
  incidentController.updateIncidentStateSolved,
); // Ruta para actualizar el estado de una incidencia a "resuelta"
